...
<AccordionGroup>
  <Accordion icon="circle-info" title="INFO — General Information">
  ...
  <Accordion icon="triangle-exclamation" title="WARN — Warning">
  ...
  <Accordion icon="circle-xmark" title="ERROR — Error">
  ...
  <Accordion icon="skull" title="FATAL — Critical Failure">
